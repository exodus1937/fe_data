...
function jigaihref() {
	if ($("#org").val() == 'c21834b4-1cb0-490f-a2a8-deeaf7f7e065') { //岱海发电
		$('#jigaiInf').attr({
			href: ctx + "/XipTecProject.do?method=showPage&id=4c425127-fadb-43bd-ba46-4aa601a6b2d7"
		});
	} else if ($("#org").val() == '472212af-1977-462b-a74a-a1f36ed6562d') { //宁东发电
		$('#jigaiInf').attr({
			href: ctx + "/XipTecProject.do?method=showPage&id=ad2aeb79-31a3-4c26-98f3-9b341496cbe5"
		});
	}
}
			...
			if (ev.length != 0) {
				...
				if (a < 6) {
					for (var b = 0; b < 6 - a; a++) {
						...
						spanHtml += "<td style='text-align: center;'></td><td style='text-align: center;'></td><td style='text-align: center;'></td><td style='text-align: center;'></td><td style='text-align: center;'></td>" + "</tr>";
					}
				} else {
					for (var b = 0; b < 6; b++) {
						if (b % 2 == 0) {
						...
						spanHtml += "<td  style='text-align: center;'></td>" + "</tr>";
					}
				}
